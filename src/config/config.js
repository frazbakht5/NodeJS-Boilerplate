...
module.exports = {
  ...
  jwt: {
    ...
    nonskedingUserMeetingSelectTokenExpiryDays: envVars.JWT_NONSKEDING_USER_MEETING_SELECT_DAYS,
    nonskedingUserMeetingPollTokenExpiryDays: envVars.JWT_NONSKEDING_USER_MEETING_POLL_DAYS,
  },
  email: {
    transporter: {
